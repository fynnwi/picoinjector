...
ggsave("output/thesis_plots/04_phage_results.pdf", width = textwidth/3*2, height = textwidth/2)
ggsave("/home/fynn/Code/masterthesis/figures/04_phage_results.pdf", width = textwidth/3*2, height = textwidth/2)
```
