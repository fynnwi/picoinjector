...
occu %>% 
  ...
  theme_pretty_thesis() + 
  scale_color_manual(values = c("#0065bd", "black"), labels = c("Acquired data", "Poisson distribution")) +
  scale_shape_manual(values = c(1,2), labels = c("Acquired data", "Poisson distribution")) +
